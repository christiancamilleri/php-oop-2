...
$prodotto1 = new gioco('Pallina', '12.99€', 'descrizione prodotto etc etc etc etc',$product_category[0],'./img/palla.jpg' , 'gioco' );
...
$prodotto5 = new cuccia('Cuccia size medium', '29.99€', 'descrizione............', $product_category[0],'./img/cuccia.jpg','60cm x 60cm');
